...
class WriteTask implements Runnable {
    ...
    public void run() {
        while (true) {
            ...
            // Add Random Value between 1 & 10 to a random index in list
        }
    }
}
...
class Simulation {
    ...
    Simulation() {
        ...
        this.list.addAll(Arrays.asList(0,0,0,0));
    }
    ...
    public void simulate() {
        ...
        Thread four = new Thread(new WriteTask(list));
